package com.jumpingminds.networkrequesthandler.view
...
internal class NPSnackBar(private val context: Context) {
    ...
    inline fun show(func: NPSnackBar.() -> Unit): NPSnackBar {
        this.func()
        return this.show()
    }
